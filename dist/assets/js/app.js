...
(function (global, factory) {
            ...
            var Home = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container mx-auto p-3"},[_c('div',{staticClass:"flex flex-wrap"},[_c('div',{staticClass:"w-full xl:w-1/2 mt-2"},[_c('span',{staticClass:"text-white inline-block mr-2"},[_vm._v("Filter:")]),_vm._v(" "),_vm._l((_vm.bookFilters),function(bookFilter){return _c('label',{key:bookFilter,staticClass:"text-orange-light inline-block mr-2 ml-2 relative",attrs:{"href":"#"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.bookFilterSelected),expression:"bookFilterSelected"}],staticClass:"opacity-0 absolute",attrs:{"type":"radio","name":"book"},domProps:{"value":bookFilter,"checked":_vm._q(_vm.bookFilterSelected,bookFilter)},on:{"change":function($event){_vm.bookFilterSelected=bookFilter;}}}),_vm._v(" "),_c('span',{staticClass:"hover:underline"},[_vm._v(_vm._s(bookFilter))])])})],2),_vm._v(" "),_c('div',{staticClass:"w-full xl:w-1/2"},[_c('div',{staticClass:"text-right mt-4 xl:mt-0"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.bookTitle),expression:"bookTitle"}],staticClass:"px-2 py-2 w-full border border-grey-darker rounded xl:w-4/5",attrs:{"type":"text","placeholder":"Search book by title..."},domProps:{"value":(_vm.bookTitle)},on:{"keyup":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.findBook($event)},"input":function($event){if($event.target.composing){ return; }_vm.bookTitle=$event.target.value;}}})])])]),_vm._v(" "),_c('div',{staticClass:"flex flex-wrap mt-6"},_vm._l((_vm.books),function(book){return _c('div',{key:book.url,staticClass:"w-1/2 lg:w-1/3 xl:w-1/3 flex pl-3 pr-3 pt-8 mb-8"},[_c('div',{staticClass:"flex flex-wrap xl:flex-col"},[_c('div',{staticClass:"flex flex-wrap xl:items-start"},[_c('figure',{staticClass:"w-full pl-3 xl:pl-0 xl:w-2/5 relative border border-transparent"},[_c('div',{staticClass:"book"},[_c('ul',{staticClass:"book__front list-reset"},[_c('li',[_c('img',{staticClass:"w-full h-full align-middle shadow",attrs:{"src":book.cover,"alt":""}})]),_vm._v(" "),_c('li')]),_vm._v(" "),_c('ul',{staticClass:"book__page list-reset xl:items-center"},[_c('li'),_vm._v(" "),_c('li',[_c('a',{staticClass:"book__button inline-block text-center no-underline px-2 py-2 border border-black text-black",attrs:{"href":book.url,"target":"_blank"}},[_vm._v(" Read ")])]),_vm._v(" "),_c('li'),_vm._v(" "),_c('li'),_vm._v(" "),_c('li')]),_vm._v(" "),_vm._m(0,true),_vm._v(" "),_vm._m(1,true)])]),_vm._v(" "),_c('figcaption',{staticClass:"w-full pl-0 mt-8 xl:w-3/5 xl:pl-8 xl:mt-0"},[_c('h2',{staticClass:"text-base mb-1 font-medium"},[_c('a',{staticClass:"text-orange no-underline",attrs:{"href":book.url,"target":"_blank"}},[_vm._v(_vm._s(book.title))])]),_vm._v(" "),_c('h3',{staticClass:"text-sm mb-2 font-normal"},[_c('a',{staticClass:"text-orange-light font-weight",attrs:{"href":"book.authorUrl","target":"_blank"}},[_vm._v(_vm._s(book.author))])]),_vm._v(" "),_c('p',{staticClass:"text-sm mb-3 text-white"},[_vm._v(_vm._s(book.level))]),_vm._v(" "),_c('p',{staticClass:"overflow-hidden text-sm text-white"},[_vm._v(_vm._s(_vm._f("formatTruncate")(book.info)))])])])])])}))])},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"book__back list-reset"},[_c('li'),_vm._v(" "),_c('li')])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"book__spin list-reset"},[_c('li'),_vm._v(" "),_c('li')])}],
              name: 'Homebook__page',
              data: function data () {
                return {
                  books: [],
              ...
              mounted: function mounted () {
                ...
                fetch('books.json')
                  ...
                  .then(function (json) {
                    this$1.books = json.books;
                    this$1.booksList = json.books;
                  });
              },
              watch: {
                bookFilterSelected: function bookFilterSelected () {
                  var this$1 = this;

                  if (this.bookFilterSelected === 'All') {
                    this.books = this.booksList;
                  } else {
                    this.books = this.booksList.filter(function (book) { return book.level === this$1.bookFilterSelected; });
                  }
                }
              },
              methods: {
                findBook: function findBook () {
                  var this$1 = this;
                  ...
                  if (this.bookFilterSelected === 'All') {
                    ...
                    filterBooks = this.booksList.filter(function (book) { return book.level === this$1.bookFilterSelected; });
                  }

                  this.books = filterBooks.filter(function (book) { return book.title.toLowerCase().indexOf(this$1.bookTitle.toLowerCase()) > -1; });
                }
              }
            }
            ...
            var SiteHeader = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('header',{staticClass:"shadow px-4 bg-yellow",attrs:{"role":"banner"}},[_c('div',{staticClass:"container mx-auto"},[_c('nav',{staticClass:"flex"},[_c('router-link',{staticClass:"text-grey-darkest text-base flex items-center no-underline router-link-exact-active router-link-active p-3 w-2/5 md:w-1/5",attrs:{"to":"/"}},[_c('img',{attrs:{"src":"assets/images/logo_jsbooks.png","alt":""}})])],1)])])},staticRenderFns: [],
              name: 'SiteHeader'
            }

            var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app",attrs:{"id":"app"}},[_c('site-header'),_vm._v(" "),_c('main',{staticClass:"pt-4",attrs:{"role":"main"}},[_c('router-view')],1)],1)},staticRenderFns: [],
              name: 'app',
              components: { SiteHeader: SiteHeader }
            }
